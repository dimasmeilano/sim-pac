...
Route::middleware(['auth'])->group(function () {
    ...
    Route::put('/profile', [OrganizationSettingController::class, 'profileUpdate'])->name('profile.update');
    ...
    Route::resource('ttd-digital', App\Http\Controllers\Admin\TtdDigitalController::class)->middleware('auth');

    // Tanda Tangan Digital (Upload)
