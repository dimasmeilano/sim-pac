...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 text-gray-800">Tambah Data Alumni</h1>
            ...
            <div class="card-body">
                <form action="{{ route('alumni.store') }}" method="POST">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="jenis_organisasi"
                                    ...
                                    <option value="ipnu" {{ old('jenis_organisasi') == 'ipnu' ? 'selected' : '' }}>Majelis
                                        Alumni IPNU</option>
                                    <option value="ippnu" {{ old('jenis_organisasi') == 'ippnu' ? 'selected' : '' }}>Forum
                                        Alumni IPPNU</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="tahun_angkatan" class="form-control" placeholder="Contoh: 2015"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="jabatan_terakhir" class="form-control"
                                    placeholder="Contoh: Ketua PAC 2018-2020" value="{{ old('jabatan_terakhir') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="profesi" class="form-control"
                                    placeholder="Contoh: Guru / Pengusaha" value="{{ old('profesi') }}">
                            </div>

                            <div class="form-group mb-3">
                                <label>Instansi / Tempat Kerja</label>
                                <input type="text" name="instansi_pekerjaan" class="form-control"
                                    placeholder="Contoh: Kemenag / PT Mencari Cinta Sejati"
                                    value="{{ old('instansi_pekerjaan') }}">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="bersedia_menjadi_donatur" class="form-control">
                                    <option value="1" {{ old('bersedia_menjadi_donatur') == '1' ? 'selected' : '' }}>
                                        Ya, Bersedia</option>
                                    <option value="0" {{ old('bersedia_menjadi_donatur') == '0' ? 'selected' : '' }}>
                    ...
                    <div class="form-group mb-4 mt-3">
                        ...
                        <textarea name="alamat_domisili" rows="3" class="form-control">{{ old('alamat_domisili') }}</textarea>
                    </div>
